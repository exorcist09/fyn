    ...
    public void sendDailyIncomeExpenseReminder() {
        ...
        for(ProfileEntity profile : profiles) {
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    + "This is a friendly reminder to add your income and expenses for today in Fyn.<br><br>"
                    + "<a href="+frontendUrl+" style='display:inline-block;padding:10px 20px;background-color:#4CAF50;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to Fyn </a>"
                    + "<br><br>Best regards,<br>Fyn Team";
    ...
    public void sendDailyExpenseSummary() {
        ...
        for (ProfileEntity profile : profiles) {
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                table.append("</table>");
                String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>Fyn Team";
